-- ============================================================
-- PropertyOS — 0001_init.sql  (CORRECTED ORDERING)
-- Run FIRST in the Supabase SQL Editor (click "Run without RLS"),
-- then 0002_rls, 0003_onboarding, 0004_leases, 0005_payments.
-- ============================================================
...
-- Defined AFTER memberships exists (this is the fix)
